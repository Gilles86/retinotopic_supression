...
TSV = REPO / 'notes' / 'af_dog_v3_target_parameters.tsv'
OUT = REPO / 'notes' / 'figures' / 'af_dyn_v3_dog_target_results.pdf'
...
def main():
    ...
    with PdfPages(OUT) as pdf:
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  PHASIC TARGET-CAPTURE gain  '
            f'(n={n})',
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  RAW dynamic-distractor gains  '
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  sustained HP-specificity  '
            f'(n={n})',
            fontsize=13, weight='bold',
        )
        fig.tight_layout(rect=[0, 0, 1, 0.95])
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  dynamic HP-specificity  '
            f'(n={n})',
            fontsize=13, weight='bold',
        )
        fig.tight_layout(rect=[0, 0, 1, 0.95])
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  RAW sustained gains  '
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  net phasic distractor effect  '
            f'(n={n})',
            fontsize=13, weight='bold',
        )
        fig.tight_layout(rect=[0, 0, 1, 0.95])
        ...
        fig.suptitle(
            f'DoG dyn-v3 + target  —  spatial extents  n={n}',
            fontsize=13, weight='bold',
        )
        fig.tight_layout(rect=[0, 0, 1, 0.94])
        pdf.savefig(fig); plt.close(fig)
