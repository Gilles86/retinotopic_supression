...
def main(subject, model_label, bids_folder='/data/ds-retsupp', grid_r2_thr=0.05, max_n_iterations=100, debug=False, resolution=50):
    ...
    hrf_model = SPMHRFModel(tr=1.6, delay=4.5, dispersion=.75)
    ...
    if model_label == 1:
        ...
        gaussian_hrf_pars = gaussian_hrf_fitter.fit(init_pars=gaussian_hrf_init_pars, max_n_iterations=max_n_iterations)
        ...
        dog_hrf_pars = dog_hrf_fitter.fit(init_pars=dog_hrf_init_pars, max_n_iterations=max_n_iterations)
...
if __name__ == "__main__":
    ...
    argument_parser.add_argument('--resolution', default=50, type=int, help='Resolution of PRF stimulus')
    ...
    main(args.subject, model_label=args.model, bids_folder=args.bids_folder, grid_r2_thr=args.r2_thr, debug=args.debug, resolution=args.resolution)
