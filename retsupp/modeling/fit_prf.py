...
def main(subject, model, bids_folder='/data/ds-retsupp', grid_r2_thr=0.02, max_n_iterations=250):
    ...
    grid_x = np.linspace(-4, 4, 12)
    grid_y = np.linspace(-4, 4, 12)
    grid_sd = np.linspace(.33, 6, 8)
