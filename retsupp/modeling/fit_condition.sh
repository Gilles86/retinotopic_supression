...
python $HOME/git/retsupp/retsupp/modeling/fit_condition.py $subject --model "$model" --bids_folder /shares/zne.uzh/gdehol/ds-retsupp --max_n_iterations 4000 --r2_thr 0.06 \
